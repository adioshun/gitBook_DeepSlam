...
- 토폴로지 맵핑은 metric정보를 잃어 버리고 오직 공간인식을 이용하여 그래프를 생성한다. 그래프의 각 노드는 식별가능한 Place이고 그래프의 엣지는 place간의 접근도이다. As mentioned in Section I, topological mapping drops the metric information and only leverages place recognition to build a graph in which the nodes represent distinguishable “places”, while edges denote reachability among places. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQzNDAwODI5XX0=
-->