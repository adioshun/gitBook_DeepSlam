...
- metric representation (or metric map는 More formally, a metric representation (or metric map) is a symbolic structure that encodes the geometry of the environment.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTQxNjczNjg1XX0=
-->