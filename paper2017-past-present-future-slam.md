...
- 최근 연구는 [26]이다. 이 방식은 모션 예측`(motion estimation)`을 이용하였으며 희박한 시멘틱 세그멘티이션을 서로 다른 물체 탐지 방법에 적용항More recently, Cadena et al. [26] use motion estimation, and interconnect a coarse semantic segmentation with different object detectors to outperform the individual systems. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEzMzQzNTc5M119
-->