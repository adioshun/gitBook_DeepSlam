...
- 시멘틱 맵이후에 시멘틱 정보`(semantic classes orobjects)`를 이용하는 연구가 진행 되었다. Soon after the first semantic maps came out, another trend started by taking advantage of known semantic classes or objects. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNDgwOTQyMTldfQ==
-->