...
- metric representation (or metric map)`는 More formally, a metric representation (or metric map) is a symbolic structure that encodes the geometry of the environment.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzk1MjkxMjk0XX0=
-->